...
CONVARS.SWEPSnapToNavmeshGeometry = CreateClientConVar("d3bot_snap_navgeometry", 1, true, true, "Enables snapping to navmesh geometry (edge points or polygon corners) for the 3D cursor.")
